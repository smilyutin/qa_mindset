...
|------|----------------|
| Requirements | Clarify acceptance criteria, identify risks |
| Design | Review architecture and data flows |
| Development | Prepare tests, validate APIs, collaborate early |
| Testing | Execute, explore, automate, validate data |
| Deployment | Smoke tests, release readiness |
| Maintenance | Regression, monitoring, defect analysis |
